              ...
              <Link to="/" className="flex items-center gap-2 group">
                ...
                <div className="flex flex-col justify-center -ml-1">
                  <img
                    ...
                    alt="mStore"
                    className="h-6 w-auto object-contain object-left mix-blend-multiply"
                  />
                  <span className="text-[9px] text-zinc-500 font-bold uppercase tracking-widest mt-0.5 pl-0.5">
                    USED & NEW IPHONES
                  </span>
                </div>
              </Link>
