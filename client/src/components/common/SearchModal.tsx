          ...
          {query.trim() === '' ? (
            ...
            results.map((product) => (
              <button
                ...
                className="w-full flex items-center justify-between p-3 bg-zinc-50 hover:bg-zinc-100 border border-zinc-200 rounded-xl cursor-pointer transition-colors group text-left"
              >
